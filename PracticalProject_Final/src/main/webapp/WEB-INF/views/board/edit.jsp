  ...
  <div class="w3-top">
    <div class="w3-bar w3-theme-d2 w3-left-align">
      <a class="w3-bar-item w3-button w3-hide-medium w3-hide-large w3-right w3-hover-white w3-theme-d2"
        href="javascript:void(0);" onclick="openNav()"><i class="fa fa-bars"></i></a> <a href="../index.jsp"
        class="w3-bar-item w3-button w3-blue"><i class="fa fa-home w3-margin-right"></i>StudySetter();</a> <a
        href="../introduction.jsp" class="w3-bar-item w3-button w3-hide-small w3-hover-white">소개</a>
      <div class="w3-dropdown-hover w3-hide-small">
        ...
        <div class="w3-dropdown-content w3-card-4 w3-bar-block">
          ...
          <a href="international-studies-languages-and-literature.jsp" class="w3-bar-item w3-button">국제어문학부</a> <a
            href="management-and-econmics.jsp" class="w3-bar-item w3-button">경영경제학부</a>
          <a href="school-of-law.jsp" class="w3-bar-item w3-button">법학부</a> <a href="school-of-communication-arts.jsp"
            class="w3-bar-item w3-button">커뮤니케이션학부</a> <a href="spatial-environment-system-engineering.jsp"
            class="w3-bar-item w3-button">공간환경시스템공학부</a>
          <a href="machanical-and-control-engineering.jsp" class="w3-bar-item w3-button">기계제어공학부</a> <a
            href="contents-convergence-design.jsp" class="w3-bar-item w3-button">콘텐츠융합디자인학부</a> <a
            href="life-sciences.jsp" class="w3-bar-item w3-button">생명과학부</a> <a
            href="computer-science-and-electrical-engineering.jsp" class="w3-bar-item w3-button">전산전자공학부</a>
          <a href="counselling-psychology-and-social-welfare.jsp" class="w3-bar-item w3-button">상담심리사회복지학부</a>
          <a href="global-entrepreneurship-and-ICT.jsp" class="w3-bar-item w3-button">ICT창업학부</a> <a
            href="school-of-creative-convergence-education.jsp" class="w3-bar-item w3-button">창의융합교육원</a> <a
            href="ai-convergence-education.jsp" class="w3-bar-item w3-button">AI융합교육원</a>
        </div>
      </div>
      <a href="login.jsp" onclick="document.getElementById('id01').style.display='block'"
  ...
  <footer class="w3-container w3-padding-32 w3-theme-d1 w3-center">
    ...
    <div style="position: relative; bottom: 100px; z-index: 1;" class="w3-tooltip w3-right">
      <span class="w3-text w3-padding w3-blue w3-hide-small">Go To
        Top</span> <a class="w3-button w3-theme" href="#myPage"><span class="w3-xlarge"> <i
