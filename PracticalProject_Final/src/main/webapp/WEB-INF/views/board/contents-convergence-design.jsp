...
<body id="myPage">
    ...
    <div class="w3-display-container w3-animate-opacity">
      <img src="../img/contents.jpg" style="width:100%; min-height:100px; max-height:500px; filter: brightness(50%);;">
      <div class="w3-container w3-display-middle w3-text-white">
        <h1>콘텐츠융합디자인학부 게시판</h1>
        <p>원하는 스터디를 찾아보세요!</p>
      </div>
			<a href="#"
    ...
    <!-- Image Header -->
    <div class="w3-display-container w3-animate-opacity">
      <img src="../src/contents.jpg" style="width:100%; min-height:100px; max-height:500px; filter: brightness(50%);;">
      <div class="w3-container w3-display-middle w3-text-white">
        <h1>콘텐츠융합디자인학부 게시판</h1>
        <p>원하는 스터디를 찾아보세요!</p>
      </div>
      <button class="w3-button w3-large w3-blue w3-display-bottomright">글쓰기 <i class="fa fa-plus"></i></button>
    </div>
    ...
    <div class="table-responsive w3-padding-32">
      <table class="table table-sm">
        ...
        <tbody>
          <tr>
            <td>1</td>
            <td> 21-1학기 동안 열심히 하실 분! #컴퓨터 구조 #강의형</td>
            <td>민달팽이</td>
            <td>2021/12/10 ~ 2021/12/12</td>
            <td>1/4</td>
          </tr>
          <tr>
            <td>1,002</td>
