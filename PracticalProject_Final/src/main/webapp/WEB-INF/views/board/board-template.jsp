...
<body id="myPage">
    ...
    <div class="w3-bar w3-theme-d2 w3-left-align">
      ...
      <div class="w3-dropdown-hover w3-hide-small">
        ...
        <div class="w3-dropdown-content w3-card-4 w3-bar-block">
          ...
          <a href="international-studies-languages-and-literature.jsp" class="w3-bar-item w3-button">국제어문학부</a>
          <a href="management-and-econmics.jsp" class="w3-bar-item w3-button">경영경제학부</a>
          <a href="school-of-law.jsp" class="w3-bar-item w3-button">법학부</a>
          <a href="school-of-communication-arts.jsp" class="w3-bar-item w3-button">커뮤니케이션학부</a>
          <a href="spatial-environment-system-engineering.jsp" class="w3-bar-item w3-button">공간환경시스템공학부</a>
          <a href="machanical-and-control-engineering.jsp" class="w3-bar-item w3-button">기계제어공학부</a>
          <a href="contents-convergence-design.jsp" class="w3-bar-item w3-button">콘텐츠융합디자인학부</a>
          <a href="life-sciences.jsp" class="w3-bar-item w3-button">생명과학부</a>
          <a href="computer-science-and-electrical-engineering.jsp" class="w3-bar-item w3-button">전산전자공학부</a>
          <a href="counselling-psychology-and-social-welfare.jsp" class="w3-bar-item w3-button">상담심리사회복지학부</a>
          <a href="global-entrepreneurship-and-ICT.jsp" class="w3-bar-item w3-button">ICT창업학부</a>
          <a href="school-of-creative-convergence-education.jsp" class="w3-bar-item w3-button">창의융합교육원</a>
          <a href="ai-convergence-education.jsp" class="w3-bar-item w3-button">AI융합교육원</a>
        </div>
      </div>
      <a href="login.jsp" onclick="document.getElementById('id01').style.display='block'" class="w3-bar-item w3-button w3-hide-small w3-right w3-hover-blue">Log in</a>    
    </div>
  ...
  <div class="w3-container w3-padding-64 w3-center" id="board">
    ...
    <div class="w3-display-container w3-animate-opacity">
      <img src="../src/artificial-intelligence.jpg"
        style="width:100%; min-height:100px; max-height:500px; filter: brightness(50%);;">
      <div class="w3-container w3-display-middle w3-text-white">
        <h1>전산전자공학부 게시판</h1>
        <p>원하는 스터디를 찾아보세요!</p>
      </div>
      <a href="#" onclick="document.getElementById('id02').style.display='block'"
        class="w3-button w3-large w3-blue w3-display-bottomright">글쓰기 <i class="fa fa-plus"></i></a>
      <!-- 글쓰기 in clicked -->
      <div id="id02" class="w3-modal">
        <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:80py">
          ...
          <!-- Form -->
          <form class="w3-container w3-padding" action="board/add">
            <div class="w3-section w3-padding">
              <h5 class="w3-text-black w3-center w3-padding">게시글 작성</h5><br>
              <label class="w3-left w3-margin-left"><b>제목</b></label>
              <input class="w3-input w3-border w3-margin-bottom" type="text" placeholder="형식 : 제목 #관련과목 #스터디형식 ..."
                name="title" required>
            </div>
            <div class="w3-section">
              <div class="col-sm-6 w3-half form-group">
                <label class="w3-left w3-margin-left"><b>작성자 이름</b></label>
                <input class="w3-input w3-border" type="text" placeholder="ex) 이달팽" name="name" required>
              </div>
              <div class="col-sm-6 w3-half form-group">
                <label class="w3-left w3-margin-left"><b>작성자 학번</b></label>
                <input class="w3-input w3-border" type="text" placeholder="ex) 220XXXXX" name="psw" required>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-6 w3-half form-group">
                ...
                <input class="w3-input w3-border" type="text" placeholder="ex) 민달팽이" name="studyName" required><br>
              </div>
            </div>
            <div class="w3-section w3-padding">
              <label class="w3-left w3-margin-left"><b>오픈챗 링크 </b><a href="https://fervors.tistory.com/185"
                  target="_blank"> 생성방법 보러 가기</a></label>
              <input class="w3-input w3-border" type="text" placeholder="ex) https://open.kakao.com/a/bcdeF" name="name"
                required>
            </div>
            <div class="w3-section">
              <div class="col-sm-6 w3-half form-group">
                <label class="w3-left w3-margin-left"><b>총 인원수</b></label>
                <input class="w3-input w3-border" type="number" min="2" placeholder="ex) 4" name="maxPerson"
                  required><br>
              </div>
              <div class="col-sm-6 w3-half form-group">
            ...
            <div class="w3-section w3-padding">
              ...
              <input class="w3-input w3-border" type="text" style="height: 300px;" placeholder="어필도 좋습니다!"
          ...
          <tbody>
            <c:foreach items="${list}" var="u">
              <tr>
                ...
                <td><a onclick="document.getElementById('id03').style.display='block'">Edit</a></td>
                  ...
                  <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="max-width:80py">
                    ...
                    <form class="w3-container w3-padding" action="/board/editpost/${u.getSeq()}">
                      ...
                      <div class="w3-section">
                        <div class="col-sm-6 w3-half form-group">
                          <label class="w3-left w3-margin-left"><b>총 인원수</b></label>
                          <input class="w3-input w3-border" type="number" min="2" placeholder="<%= u.getMaxStudent()%>" name="maxPerson"
                            required><br>
                        </div>
                        <div class="col-sm-6 w3-half form-group">
                          <label class="w3-left w3-margin-left"><b>모집 마감일</b></label>
