...
<body id="myPage">
  ...
  <div class="w3-top">
    <div class="w3-bar w3-theme-d2 w3-left-align">
      ...
      <a href="index.html" class="w3-bar-item w3-button w3-blue"><i class="fa fa-home w3-margin-right"></i>StudySetter();</a>
      <a href="introduction.html" class="w3-bar-item w3-button w3-hide-small w3-hover-white">소개</a>
